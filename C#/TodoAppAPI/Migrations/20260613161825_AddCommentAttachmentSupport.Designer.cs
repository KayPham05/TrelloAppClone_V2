...
namespace TodoAppAPI.Migrations
{
    ...
    [Migration("20260613161825_AddCommentAttachmentSupport")]
    partial class AddCommentAttachmentSupport
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TodoAppAPI.Models.CommentAttachment", b =>
                {
                    b.Property<string>("AttachmentUId")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
            ...
            modelBuilder.Entity("TodoAppAPI.Models.UserStarredBoard", b =>
                {
                    b.Property<string>("UserStarredBoardUId")
                        .HasMaxLength(128)
                        .HasColumnType("nvarchar(128)");
                    ...
                    b.HasKey("UserStarredBoardUId");

                    b.HasIndex("BoardUId");

                    b.HasIndex("StarredAt");

                    b.HasIndex("UserUId", "BoardUId")
                        .IsUnique();

                    b.ToTable("UserStarredBoard", (string)null);
                });
            ...
            modelBuilder.Entity("TodoAppAPI.Models.CommentAttachment", b =>
                {
                    b.HasOne("TodoAppAPI.Models.Comment", "Comment")
                        .WithMany("Attachments")
                        .HasForeignKey("CommentUId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
